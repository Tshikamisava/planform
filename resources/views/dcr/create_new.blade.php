...
<div class="max-w-4xl mx-auto space-y-6 relative pb-12">
    <!-- Toast Notification -->
    <div id="toast" class="hidden fixed top-24 right-8 z-50 bg-blue-800 text-white px-4 py-3 rounded-xl shadow-xl flex items-center gap-3 animate-fade-in border border-blue-900">
    ...
    <!-- Success Modal -->
    <div id="success-modal" class="hidden fixed inset-0 bg-blue-900/90 backdrop-blur-xl z-[100] flex items-center justify-center p-4 animate-fade-in">
        <div class="bg-white rounded-[3rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] p-12 max-w-md w-full text-center border border-slate-100">
            ...
            <a href="{{ route('dcr.dashboard') }}" class="inline-block w-full py-4 bg-blue-800 text-white rounded-2xl font-bold hover:bg-blue-700 transition-all shadow-xl shadow-blue-800/20 uppercase tracking-widest text-xs">
