...
@section('title', 'Create DCR')

@section('content')
<div class="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        <div class="bg-blue-600 px-6 py-4">
            <h1 class="text-2xl font-bold text-white">Create New Change Request</h1>
            <p class="text-blue-100 mt-1">Submit a new DCR for review and approval</p>
        </div>
                            ...
                            <select id="decision_maker_id" 
                                ...
                                @foreach ($decisionMakers as $decisionMaker)
                                    <option value="{{ $decisionMaker->id }}" {{ old('decision_maker_id') == $decisionMaker->id ? 'selected' : '' }}>
                                        {{ $decisionMaker->name }} - {{ $decisionMaker->department }}
                                    </option>
                                @endforeach
                            </select>
        ...
        <div class="flex justify-between items-center">
            <a href="{{ route('dcr.dashboard') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                Cancel
            </a>
            
            <div class="space-x-3">
                <button type="submit" name="action" value="save_draft" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Save as Draft
                </button>
                <button type="submit" name="action" value="submit" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Submit for Review
                </button>
            </div>
        </div>
